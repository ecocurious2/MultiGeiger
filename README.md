 ...
 * Position  
 ...
 Nun mit *Einstellungen speichern* das Ganze beenden. Dann auf der Übersichts-Seite  bei diesem Sensor auf *Daten* klicken. Nun steht hinter *Sensor ID* die ID des Sensors. Diese bitte merken: sie wird für die Abfrage bei luftdaten.info bzw. bei der Anzeige auf geiger.rexfue.de benötigt (zur Zeit heißt das noch test1.rexfue.de und ist laufend in Arbeit - kann also ab und zu ausfallen :wink: )
