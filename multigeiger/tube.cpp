...
void IRAM_ATTR isr_GMC_count() {
  static unsigned long timestamp_us, timestamp_us_prev, timestamp_us_prev_used;
  ...
  timestamp_us = micros();
  if ((timestamp_us - timestamp_us_prev) > GMC_DEAD_TIME) {
    ...
    isr_count_time_between = timestamp_us - timestamp_us_prev_used;  // save for statistics debuging
    timestamp_us_prev_used = timestamp_us;
  }
  #if PIN_TEST_OUTPUT >= 0
